if(NOT ANDROID)
  ...
  ExternalProject_Add(openfst
          ...
          CONFIGURE_COMMAND PATH=${CMAKE_PREFIX_PATH}/bin:$ENV{PATH} ${openfst_SOURCE_DIR}/configure --disable-bin --enable-static --host=${CMAKE_LIBRARY_ARCHITECTURE} "CXX=${ANDROID_CXX_COMPILER} -target ${CMAKE_LIBRARY_ARCHITECTURE}${ANDROID_NATIVE_API_LEVEL}" "CXXFLAGS=-I${gflags_BINARY_DIR}/include -I${glog_SOURCE_DIR}/src -I${glog_BINARY_DIR} -fPIC" "LIBS=${gflags_BINARY_DIR}/lib/libgflags_nothreads.a ${glog_BINARY_DIR}/libglog.a"
          COMMAND           cp ${CMAKE_SOURCE_DIR}/asr/android_patch/log.h ${openfst_SOURCE_DIR}/src/include/fst
          COMMAND           cp ${CMAKE_SOURCE_DIR}/asr/android_patch/flags.h ${openfst_SOURCE_DIR}/src/include/fst
          COMMAND           cp ${CMAKE_SOURCE_DIR}/asr/android_patch/flags.cc ${openfst_SOURCE_DIR}/src/lib
  ...
  set(openfst_LIB_DIR ${BINARY_DIR}/src/lib/.libs)
